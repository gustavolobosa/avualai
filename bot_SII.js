module.exports = async function bot_SII_rol(page, variables) {
    ...
    console.log(`El valor por metro cuadrado (${valM2}) es un ${((parseFloat(valM2Parsed) / valComM2Float) * 100).toFixed(2)}% del valor comercial por metro cuadrado ($${valComM2FloatParsed})`);
